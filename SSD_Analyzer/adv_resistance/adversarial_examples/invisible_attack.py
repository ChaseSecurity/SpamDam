...
# """Class representing a Toxic Objective which injects invisible characters."""
    ...
    def __init__(self, model, input: str, max_perturbs: int, invisible_chrs: List[str] = [ZWJ,ZWSP,ZWNJ]):
...
for texts in test_data2:
    text = texts[0]
    obj = InvisibleToxicObjective(model2, text, max_p)
...
with open('./langs/adv_invisible_{}_{}.csv'.format(max_p,lang), 'w') as f:
